...
// Devices controller
angular.module('devices').controller('DevicesController', ['$scope', '$stateParams', '$location', 'Authentication', 'Devices', '$rootScope', '$mdToast', 'Devicesensors', 'Sensortypes', '$filter', 'Devicesensoralerts', '$uibModal', 'Readings2', 'DeviceSensor', '$log',
    function ($scope, $stateParams, $location, Authentication, Devices, $rootScope, $mdToast, Devicesensors, Sensortypes, $filter, Devicesensoralerts, $uibModal, Readings2, DeviceSensor, $log) {
